...
public class Main {
    public static void main(String[] args) {
        String url = "http://www3.javmost.com/get_data/changePart/240p/1/48536/thai/mooplayer";
        ...
        request.addHeader("Referer","http://www3.javmost.com/get_data/changePart/240p/1/48536/thai/mooplayer");
